...
Attendu : 10 tests passent, soit 16 avec les 6 de la tâche 1.
...
Attendu : 11 tests passent, soit 41 avec les 30 des tâches précédentes.
...
```bash
cd axie-td && git add -A && git commit -m "feat: ouvrir les fiches à l'appui long et au tap en vague"
```
